        ...
        <section id="fitur" className="py-24 bg-slate-50 px-4">
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <div className="h-1.5 w-20 bg-[var(--primary-color)] mx-auto rounded-full"></div>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    {features.map((feature, idx) => (
                        <div key={idx} className="bg-white p-10 rounded-[2.5rem] shadow-sm hover:shadow-2xl transition-all duration-500 group border border-slate-100">
                            <div className="w-16 h-16 bg-blue-50 rounded-2xl flex items-center justify-center mb-8 group-hover:bg-[var(--primary-color)] group-hover:text-white transition-colors duration-500">
                                {feature.icon}
                            </div>
