        ...
        <section className="pt-32 pb-20 md:pt-48 md:pb-32 px-4 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto text-center">
                ...
                <h1 className="text-5xl md:text-7xl font-black text-slate-900 leading-[1.1] mb-8">
                    ...
                    <span className="text-[var(--primary-color)]">Enggak Pake Ribet.</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    <button onClick={() => route.replace('https://fe-ketujuan.vercel.app/auth/login')} className="w-full sm:w-auto bg-[var(--primary-color)] text-white px-10 py-5 rounded-2xl text-lg font-bold hover:bg-[var(--secondary-color)] shadow-xl shadow-[var(--secondary-color)] flex items-center justify-center gap-2 transition-all hover:-translate-y-1">
                    ...
                    <button className="w-full sm:w-auto bg-white text-slate-800 px-10 py-5 rounded-2xl text-lg font-bold border border-slate-200 hover:bg-slate-50 transition-all flex items-center justify-center gap-2">
                        <Smartphone size={20} className="text-[var(--primary-color)]" /> Lihat Demo
                    </button>
                </div>
