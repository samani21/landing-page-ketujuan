        ...
        <section className="py-20 px-4">
            <div className="max-w-5xl mx-auto bg-emerald-950 rounded-[4rem] p-10 md:p-20 text-center relative overflow-hidden shadow-2xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center relative">
                    <button onClick={() => route.replace('https://fe-ketujuan.vercel.app/login')} className="bg-white text-emerald-950 px-10 py-5 rounded-2xl font-black text-lg hover:bg-emerald-50 transition-all flex items-center justify-center gap-2">
